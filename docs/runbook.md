...
```bash
# 1. Buat direktori autostart XFCE jika belum ada
mkdir -p ~/.config/autostart

# 2. Salin file .desktop ke direktori autostart
cp /home/orangepi/Downloads/cv/gema-imam-desktop.desktop ~/.config/autostart/

# 3. Pastikan script runner punya permission executable
chmod +x /home/orangepi/Downloads/cv/run_desktop.sh
```
